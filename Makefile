...
build: $(BUILD_DIR) controller storage client
...
help:
	...
	@echo "  all          - Clean, get dependencies, generate proto files, and build all components"
